...
public interface ExcepcionRepository extends JpaRepository<Excepcion, ExcepcionPK> {
    ...
    public Optional<Excepcion> buscarExistenciaTerminadaExcepcionExc(@Param("ASIGNATURA") Asignatura Asig, @Param("AlUMNO") Alumno alumno);
    ...
    public Optional<Excepcion> buscarExistenciaTerminadaExcepcionConv(@Param("ASIGNATURA") Asignatura Asig, @Param("AlUMNO") Alumno alumno);
